...
export default class Calculation extends Component{
    ...
    render(){
        ...
        const newCar = this.state.checkNewCar ? null:
                <React.Fragment>
        ...
        return (
            <div className={style.calculation}>
                <form className='justify-content-center' onSubmit={this.handleSubmitCalculations}>
                    ...
                    <div className="custom-control custom-switch d-flex justify-content-start ml-3  mt-4">
            ...
            <div className="row">
                <div className="col-5">
                    <div className="form-group">
                        ...
                        <span className="ml-2" >{tenure} лет</span>
                        <div className="form-group mt-2">
                    ...
                    <div className="col-4">
                        ...
                        <div className="form-group d-flex flex-column">
                            ...
                            <div className="d-flex col-9">
                                <span className={style.period_wheels}>Каждые</span>
                                <input type="text" className="form-control"/>
                            </div>
                        </div>
                        <div className="form-group">
                ...
                <div className={style.wrapp}>
                    <div className="row justify-content-between">
                        <div className="d-flex">
                            <div className={style.period_wheels}><span>Частота смены комплекта:</span></div>
                            <div className="form-group">
                                <select className="custom-select">
                            ...
                            <div className={style.period_wheels}><span>лет</span></div>
                        </div>
                        <div className="d-flex">
                            <div className={style.period_wheels}><span>Частота смены комплекта:</span></div>
                            <div className="form-group">
